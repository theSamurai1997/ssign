...
with st.sidebar:
    ...
    with st.expander("Tool Citations", expanded=False):
        st.markdown(
            "**MacSyFinder v2:** Abby, S.S., et al. (2014). MacSyFinder: A Program "
            "to Mine Genomes for Molecular System Components with an Application to "
            "CRISPR-Cas Systems. *PLoS ONE*, 9(10), e110726. "
            ...
            "**DeepLocPro:** Thumuluri, V., et al. (2022). DeepLoc 2.0: multi-label "
            "subcellular localization prediction using protein language models. "
            "*Nucleic Acids Research*, 50(W1), W228-W234. doi:10.1093/nar/gkac278\n\n"
            "**DeepSecE:** Zhang, J., et al. (2023). DeepSecE: A Deep-Learning-Based "
            "Framework for Multiclass Prediction of Secreted Proteins in Gram-Negative "
            "Bacteria. *Research*, 6, 0129. doi:10.34133/research.0129\n\n"
            ...
            "Biotechnology*, 40, 1023-1025. doi:10.1038/s41587-021-01156-3\n\n"
            "**BLAST+:** Camacho, C., et al. (2009). BLAST+: architecture and "
            "applications. *BMC Bioinformatics*, 10, 421. doi:10.1186/1471-2105-10-421\n\n"
            "**HH-suite:** Steinegger, M., et al. (2019). HH-suite3 for fast remote "
            "homology detection and deep protein annotation. *BMC Bioinformatics*, "
            "20, 473. doi:10.1186/s12859-019-3019-7\n\n"
            "**InterProScan:** Jones, P., et al. (2014). InterProScan 5: genome-scale "
            ...
            "structure search with Foldseek. *Nature Biotechnology*, 42, 243-246. "
            ...
            "prokaryotic genomes. *Journal of Open Source Software*, 7(72), 4296. "
...
with tab_upload:
    ...
    uploaded_files = st.file_uploader(
        ...
        help=(
            "GenBank (.gbff/.gbk), GFF3 (.gff3), or FASTA contigs (.fasta/.fna). "
            "Upload multiple files for batch processing. GenBank files are recommended "
            "as they include gene names and functional annotations."
        ),
